            ...
            <div class="col-sm-8">
                <div class="card text-center">
                    <div class="card-heading">
                        <h4 class="heading" text-align="center">Enter the personal details of the visitor expected</h4>
                    </div>                        
                    <div class="card-body">
                        <form name="form" action="registerAdminPreRegister" method="post">
                            ...
                            <input type="time" id="exp_time" name="exp_time"><br>
