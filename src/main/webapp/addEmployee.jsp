...
<body>
    <nav class="navbar navbar-light bg-light" width="70%">
        <div class="container-fluid">
            <img src="C:\Users\SoumyaJ\Project\src\main\webapp\images\itt.png" class="ittimage">
            ...
            <div class="col-sm-8">
                <div class="card text-center">
                    <div class="card-heading">
                        <h4 class="heading" text-align="center">Enter the details of the Employee</h4>
                    </div>                        
                    <div class="card-body">
                        <form name="form" action="registerEmployee" method="post">
