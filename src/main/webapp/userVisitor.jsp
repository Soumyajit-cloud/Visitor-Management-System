        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <form name="form" action="registerUserVisitor" method="post" onSubmit="return validate()">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous">
	function validate(){
		...
		var meeting=document.form.meeting.value;
		...
		if (name==null || name=="")
	     ...
	     { 
	     alert("Address number can't be blank"); 
	     return false; 
	     }
	     else if (meeting==null || meeting=="")
	     { 
	     alert("Meeting person can't be blank"); 
	     return false; 
	     }
