        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <form name="form" action="updateAdminVisitorProcess.jsp" method="post"">
                            ...
                            <input type="date" id="date" name="date" value="<%=resultSet.getString("date") %>"><br>
                            <label for="time">Time:</label>	
                            <input type="time" id="time" name="time" value="<%=resultSet.getString("time") %>"><br>
